...
# 26 "app_device_custom_hid.c" 2
# 48 "app_device_custom_hid.c"
...
void APP_DeviceCustomHIDInitialize()
{
    ...
    USBOutHandle = (volatile void*)USBTransferOnePacket(CUSTOM_DEVICE_HID_EP,0,(uint8_t*)&ReceivedDataBuffer[0],64);
}
# 104 "app_device_custom_hid.c"
void APP_DeviceCustomHIDTasks()
{
    ...
    if(((USBOutHandle != 0x0000) && ((*(volatile uint8_t*)USBOutHandle & 0x80) != 0x00)) == 0)
    {
        ...
        switch(ReceivedDataBuffer[0])
        {
            ...
            case COMMAND_GET_BUTTON_STATUS:
                ...
                if(!((USBInHandle != 0x0000) && ((*(volatile uint8_t*)USBInHandle & 0x80) != 0x00)))
                {
                    ...
                    if(BUTTON_IsPressed(BUTTON_USB_DEVICE_HID_CUSTOM) == 0)
                    {
                    ...
                    USBInHandle = USBTransferOnePacket(CUSTOM_DEVICE_HID_EP,1,(uint8_t*)&ToSendDataBuffer[0],64);
                }
                break;
        ...
        USBOutHandle = USBTransferOnePacket(CUSTOM_DEVICE_HID_EP,0,(uint8_t*)&ReceivedDataBuffer[0],64);
    }
}
