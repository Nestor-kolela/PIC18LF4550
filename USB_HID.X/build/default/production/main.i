...
# 28 "./usb_function_hid.h" 2
# 98 "./usb_function_hid.h"
void USBCheckHIDRequest(void);
# 280 "./usb_function_hid.h"
...
void main(void) {
    ...
    while (1)
    {
        ...
        if (USBDeviceState < CONFIGURED_STATE || UCONbits.SUSPND == 1)
        {
            ...
            if (!((USBInHandle != 0x0000) && ((*(volatile uint8_t*)USBInHandle & 0x80) != 0x00)) && runFlag == 1)
            {
            ...
            if (!((USBOutHandle != 0x0000) && ((*(volatile uint8_t*)USBOutHandle & 0x80) != 0x00)))
            {
                switch (ReceivedDataBuffer[0])
                {
                    ...
                    case 0x40:
                    {
                        ...
                        if (!((USBInHandle != 0x0000) && ((*(volatile uint8_t*)USBInHandle & 0x80) != 0x00))) {
                            ...
                            ToSendDataBuffer[1] = (BYTE) 0;
                            ToSendDataBuffer[2] = (BYTE) 1;
                ...
                USBOutHandle = USBTransferOnePacket(1,0,(BYTE*) & ReceivedDataBuffer,64);
            }
        }
    }
